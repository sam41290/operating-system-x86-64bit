...
//	kprintf("p2 %p\n",p2);
	...
	p1[p1_index]=((uint64_t)p2 & 0xFFFFFFFFFFFFF000) | 23;
...
//	kprintf("p3 %p\n",p3);
	...
	p2[p2_index]=((uint64_t)p3 & 0xFFFFFFFFFFFFF000) | 23;
	base=(((base >> 48)<<9)|0x1FE)<<39;
    base=(((base >> 39)<<9)|0x1FE)<<30;
    base=(((base >> 30)<<9)|p1_index)<<21;
    base=(((base >> 21)<<9)|p2_index)<<12;
...
//	kprintf("p4 %p\n",p4);
	...
	p3[p3_index]=((uint64_t)p4 & 0xFFFFFFFFFFFFF000) | 23;
	base=(((base >> 48)<<9)|0x1FE)<<39;
    base=(((base >> 39)<<9)|p1_index)<<30;
    base=(((base >> 30)<<9)|p2_index)<<21;
    base=(((base >> 21)<<9)|p3_index)<<12;
    ...
    p4[p4_index]=((uint64_t)padd & 0xFFFFFFFFFFFFF000) | 23;
    for (int i = 0; i < 512; ++i)
    {
    	*((uint64_t*)(vadd+i)) = 0;
    }
